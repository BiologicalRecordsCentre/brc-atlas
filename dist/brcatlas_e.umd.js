(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.brcatlas_e = {}, global.d3));
  ...
  */
  ...
  function eSvgMap(_ref) {
    var _ref$selector = _ref.selector,
        ...
        mapid = _ref$mapid === void 0 ? 'eSvgMap' : _ref$mapid,
        ...
        _ref$hightlightAllEur = _ref.hightlightAllEurope,
        hightlightAllEurope = _ref$hightlightAllEur === void 0 ? false : _ref$hightlightAllEur,
    ...
    function displayMapBackground() {
      d3.json(boundaryEuropeGjson).then(function (data) {
        var dataFeaturesHighlight = data.features.filter(function (d) {
          return hightlightAllEurope || highlightCountries.includes(d.properties.SOVEREIGNT);
        });
    ...
    function mapData(week, year) {
      ...
      var dWeek0 = dYear.filter(function (d) {
        return d.week === week;
      });
      var dWeek1 = dYear.filter(function (d) {
        return d.week === week - 1;
      });
      var dWeek2 = dYear.filter(function (d) {
        return d.week === week - 2;
      }); // Remove all duplicates

      dWeek0 = dWeek0.filter(function (v, i, self) {
        return i === self.findIndex(function (d) {
          return d.id === v.id;
        });
      });
      dWeek1 = dWeek1.filter(function (v, i, self) {
        return i === self.findIndex(function (d) {
          return d.id === v.id;
        });
      });
      dWeek2 = dWeek2.filter(function (v, i, self) {
        return i === self.findIndex(function (d) {
          return d.id === v.id;
        });
      }); //
    ...
    function loadData(data) {
      ...
      var epsg3035 = '+proj=laea +lat_0=52 +lon_0=10 +x_0=4321000 +y_0=3210000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs +type=crs';
      dataGridded = data.map(function (d) {
