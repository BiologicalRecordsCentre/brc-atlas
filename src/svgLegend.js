        ...
        if (l.text[i] === 'symbol') {
          if (shape === 'circle') {
            dot = gLegend.append('circle')
              ...
              .attr("cy", lineHeight * (y + 2.5) - swatchPixels)
            ...
            dot = gLegend.append('rect')
              ...
              .attr("y", lineHeight * (y + 2.5) - 2 * swatchPixels + swatchPixels * (1 - size))
          ...
          gLegend.append('text')
            ...
            .attr('y', lineHeight * (y + 2.5) - lineHeight/20)
            .text(l.text[i])
        }
      }
    }
